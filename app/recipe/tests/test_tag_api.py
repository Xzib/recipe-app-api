...
class PrivateTagsApiTests(TestCase):
    ...
    def test_tags_limited_to_user(self):
        ...
        Tag.objects.create(user=user, name='Sweet')
    ...
    def test_retrive_tags_assigned_to_unique(self):
        """Return unique tags assigned to recipes"""
        tag = Tag.objects.create(user=self.user, name='supper')
        Tag.objects.create(user=self.user, name='meetha')
